...
public class Threads {
	...
	public static void main(String[] args) {
		...
		System.out.println("default name is " + t2.getName());
		t2.setName("hp");
		System.out.println("updated name is " + t2.getName());

		System.out.println("default name is " + t7.getName());
		t7.setName("dell");
		System.out.println("updated name is " + t7.getName());
